...
export default connect(
  ...
  (state) => ({count: state}),
  //#region 之前代码注释 
  //  映射操作状态的方法 mapDispatchToProps 精简版可以写成对象，一般写法写函数；
  // dispatch => ({
  //   // 减法
  //   decre : value => dispatch(createDecrementAction(value)),
  //   //加法
  //   incre: value => dispatch(createIncrementAction(value)),
  //   // 异步action
  //   asyncIncre: value=> dispatch(createIncrementAsyncAction((value), 500)) 
  // })
  //#endregion
  // mapDispatchToProps 简写 对象
  {
    decre:createDecrementAction,
    incre: createIncrementAction,
    asyncIncre: createIncrementAsyncAction
  }
